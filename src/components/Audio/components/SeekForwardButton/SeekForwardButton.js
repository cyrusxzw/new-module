...
import styles from './SeekForwardButton.module.css';

const SeekForwardButton = React.memo(
...
SeekForwardButton.defaultProps = {
  copy: {
    title: undefined,
  },
  isLoading: false,
