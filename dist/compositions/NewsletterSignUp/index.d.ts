...
declare function NewsletterSignUp({ className, consentErrorMsg, errorMessage, onClick, showTermsConditionsTextBox, termsAndCondition, termsMessage, theme, subscriptionMessage, }: {
    className: any;
    consentErrorMsg: any;
    errorMessage: any;
    onClick: any;
...
declare namespace NewsletterSignUp {
    namespace propTypes {
