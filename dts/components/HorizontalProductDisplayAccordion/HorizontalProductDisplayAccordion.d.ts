export function HorizontalProductDisplayAccordion({
  id,
  products,
  addToCartCopy,
}: {
...
export namespace HorizontalProductDisplayAccordion {
  namespace propTypes {
    const className: PropTypes.Requireable<string>;
    const id: PropTypes.Requireable<string>;
    const addToCartCopy: PropTypes.Requireable<
    ...
    const products: PropTypes.Requireable<
      PropTypes.InferProps<{
        closedState: PropTypes.Requireable<
          PropTypes.InferProps<{
        ...
        openState: PropTypes.Requireable<
          PropTypes.InferProps<{
            background: PropTypes.Requireable<string>;
            backgroundColour: PropTypes.Requireable<string>;
            backgroundImage: PropTypes.Requireable<object>;
            ...
            eyebrow: PropTypes.Requireable<string>;
            foregroundImage: PropTypes.Requireable<object>;
            product: PropTypes.Requireable<
              PropTypes.InferProps<{
                variants: PropTypes.Requireable<
                  PropTypes.InferProps<{
