...
# Aēsop Global Experience Language
...
Finally, once the **release** branch has been handed over, **release** is rebased and merged back into **develop** and **main** respectively (along with any hotfixes).
